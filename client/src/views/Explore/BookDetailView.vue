    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          >
            <div class="text-xl font-bold">Choose Quantity:</div>
            ...
            <div class="flex ml-6 items-center">
              ...
              <div style="margin-left: 20px">
                <a-button class="bg-[#1677ff]" type="primary" @click="toggle">
          ...
          <div class="flex">
            ...
            <button
              @click="addToCart"
              class="flex ml-auto items-center text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded"
            >
              Add to Cart
            </button>
            <button
