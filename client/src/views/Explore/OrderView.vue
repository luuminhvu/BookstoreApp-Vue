<template>
  <div class="myOrder" v-if="order.length > 0">
    <!-- component -->
    <div class="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
      ...
      <div class="flex justify-start item-start space-y-2 flex-col">
        <h1
          class="text-3xl dark:text-[#d16c82] lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800"
        >
          Order
        </h1>
        <p
          class="text-base dark:text-red-300 font-medium leading-6 text-gray-600"
        >
          {{ order.length }} orders
        </p>
      </div>
          ...
          >
            <div class="flex justify-between items-center w-full">
              ...
              <p class="text-base dark:text-white leading-6">
                <CloseOutlined
                  class="text-red-500 cursor-pointer hover:text-red-600 dark:text-red-300 dark:hover:text-red-400 text-xl"
